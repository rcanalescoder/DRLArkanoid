...
export class PanelTransicion {
  ...
  _construir() {
    this.contenedor.innerHTML = `
      <span class="seccion-titulo" style="margin:0 8px 0 0">Transición</span>
      <div class="paso-t"><span class="k">s</span><span class="v" id="t-s">—</span></div>
      <span class="flecha">→</span>
      <div class="paso-t accion"><span class="k">a</span><span class="v" id="t-a">·</span></div>
      <span class="flecha">→</span>
      <div class="paso-t reward"><span class="k">r</span><span class="v" id="t-r">0</span></div>
      <span class="flecha">→</span>
      <div class="paso-t"><span class="k">s'</span><span class="v" id="t-s2">—</span></div>
      <span class="flecha">→</span>
      <div class="paso-t"><span class="k">done</span><span class="v" id="t-done">false</span></div>
    `;
