...
Un cuaderno divulgativo de **259 páginas** en castellano (**Edición 4**) que cuenta el viaje completo: de un agente **ciego** que parecía aprender pero sacaba **0%** en niveles dispersos, al **diagnóstico** de por qué fallaba (no era el algoritmo, era la *formulación* de la tarea), la **receta** que lo desbloquea, los **fundamentos de RL y Deep RL** (el bucle agente–entorno, MDP/POMDP, valor y Bellman, exploración, replay, redes y entrenamiento) y un capítulo a fondo por cada uno de los **cinco algoritmos** —red (con diagramas), **función de pérdida**, hiperparámetros (con **búsqueda en rejilla**), resultados y comparación—. Cierra con la **medición**, la **ablación**, el **veredicto** con datos reales y anexos prácticos de instalación, mapa del código, fragmentos esenciales, glosario y lecturas recomendadas. Cada tema lleva **doble pista de lectura**: una explicación pedagógica y un recuadro rojo **«Y ahora, para expertos»** con el formalismo. Más de **100 figuras** —infografías, esquemas, capturas y gráficas derivadas de `results/ledger.csv`.

<p align="center">
  <a href="docs/Arkanoid-DRL-Learning-Lab-v4.pdf"><img src="docs/assets/pdf_cover.jpg" width="340" alt="Portada del cuaderno PDF (Edición 4)" /></a>
</p>
<p align="center">
  <a href="docs/Arkanoid-DRL-Learning-Lab-v4.pdf"><b>⬇️&nbsp;&nbsp;Descargar el PDF</b></a>
  &nbsp;&nbsp;·&nbsp;&nbsp;259 páginas&nbsp;&nbsp;·&nbsp;&nbsp;~23 MB&nbsp;&nbsp;·&nbsp;&nbsp;español
</p>
<p align="center">
  <a href="docs/Arkanoid-DRL-Learning-Lab-v4.pdf"><img src="docs/assets/pdf_preview.jpg" width="820" alt="Páginas de muestra del cuaderno (Edición 4)" /></a>
</p>
...
Una iteración de entrenamiento siempre hace lo mismo (ver el detalle ilustrado en el [cuaderno PDF](docs/Arkanoid-DRL-Learning-Lab-v4.pdf)):
...
docs/                  # cuaderno PDF v4, fuente HTML y Back/ con versiones previas
```
...
Código del laboratorio: **MIT** (ver [LICENSE](LICENSE)). © 2026 Roberto Canales Mora — con Claude y Codex · [www.robertocanales.com](https://www.robertocanales.com)
